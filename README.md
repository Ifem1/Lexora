...
```env
NEXT_PUBLIC_CONTRACT_ADDRESS=0xC3F43D4C691ABcbd014836Cd29AD1D10f04c623A
NEXT_PUBLIC_GENLAYER_RPC_URL=https://studio.genlayer.com/api
NEXT_PUBLIC_CHAIN_ID=61999
NEXT_PUBLIC_DEV_MODE=true
```

The verified rebuilt deployment is `0xC3F43D4C691ABcbd014836Cd29AD1D10f04c623A`. The legacy deployment must not be reused.
